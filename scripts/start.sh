...
nohup java -jar \
    -Dspring.config.location=classpath:/application.properties,classpath:/application-real.properties,/home/ubuntu/app/step3/application-oauth.properties,/home/ubuntu/app/step3/application-real.properties \
